...
public class KehuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody KehuEntity kehu){
    	...
    	KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("zhanghao", kehu.getZhanghao()));
		if(user!=null) {
