...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<div style="margin: 0 auto;" :style='{"width":"60%"}'>
			
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 10px 0","boxShadow":"-500px 0 100px 0px #92B4E6 inset","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 160, 176, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"16px","borderStyle":"solid"}'>
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>标题</div>
					...
					<button :style='{"padding":"0 15px","boxShadow":"0 0 8px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(146, 180, 230, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}' id="btn-search" type="button" class="layui-btn layui-btn-normal">
						<i class="layui-icon layui-icon-search"></i>搜索
																									...
																									<div class="list news list6">
												<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" :style='{"padding":"12px 50px 12px 12px","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 10px 0","borderColor":"rgba(151, 178, 226, 1)","backgroundColor":"#fff","borderRadius":"110px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"auto"}' class="list-item-body animation-box">
							<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 20px 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"100px 0 0 100px","borderWidth":"0","width":"30%","borderStyle":"solid","height":"auto"}' :src="baseurl+item.picture">
							<div class="infos">
								<div class="h">
									...
									<div class="time" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(151, 151, 151, 1)","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.addtime}}</div>
								</div>
								<div class="desc" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(151, 151, 151, 1)","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"28px","fontSize":"14px","borderStyle":"solid"}'>{{item.introduction}}</div>
								<div class="tag" :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(151, 178, 226, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"72px","lineHeight":"24px","fontSize":"12px","borderStyle":"solid"}'>新闻动态</div>
							</div>
						</div>
					</div>
