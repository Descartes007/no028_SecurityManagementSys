				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"0px 0px 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"right"}' class="layui-form-label">培训名称</label>
							<div class="layui-input-block input">
								<input type="text"  name="peixunmingcheng" name="peixunmingcheng" id="peixunmingcheng" placeholder="培训名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"right"}' class="layui-form-label">培训地点</label>
							<div class="layui-input-block input">
								<input type="text"  name="peixundidian" name="peixundidian" id="peixundidian" placeholder="培训地点" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"right"}' class="layui-form-label">培训日期</label>
							<div class="layui-input-block date">
								<input type="text" name="peixunriqi"  id="peixunriqi" placeholder="培训日期" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"right"}' class="layui-form-label">注意事项</label>
							<div class="layui-input-block input">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"right"}' class="layui-form-label">培训内容</label>
							<div class="layui-input-block input">
								<input type="text"  name="peixunneirong" name="peixunneirong" id="peixunneirong" placeholder="培训内容" autocomplete="off" class="layui-input">
							</div>
						</div>
