		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				<div class="box" style='width:60%'>
					  ...
					  <span>DATA SHOW</span><span>培训信息展示</span>
					</div>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>培训名称</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="peixunmingcheng" id="peixunmingcheng" placeholder="培训名称" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>培训地点</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="peixundidian" id="peixundidian" placeholder="培训地点" autocomplete="off" class="layui-input">
						</div>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>培训日期</div>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="peixunriqistart" id="peixunriqistart" placeholder="培训日期起始" autocomplete="off" class="layui-input">
						<span :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>至</span>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="peixunriqiend" id="peixunriqiend" placeholder="培训日期结束" autocomplete="off" class="layui-input">
					</div>
						...
						<div class="list" style="position: relative;">
							<div @click="jump('../peixunxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				function pageList() {
			        ...
			        if (jquery('#peixunmingcheng').val()) {
			          param['peixunmingcheng'] = jquery('#peixunmingcheng').val() ? '%' + jquery('#peixunmingcheng').val() + '%' : '';
			        }
			        if (jquery('#peixundidian').val()) {
			          param['peixundidian'] = jquery('#peixundidian').val() ? '%' + jquery('#peixundidian').val() + '%' : '';
			        }
			        if (jquery('#peixunriqistart').val()) {
			            param['peixunriqistart'] = jquery('#peixunriqistart').val() ? jquery('#peixunriqistart').val() : '';
			        }
			        if (jquery('#peixunriqiend').val()) {
			            param['peixunriqiend'] = jquery('#peixunriqiend').val() ?  jquery('#peixunriqiend').val() : '';
			        }
				...
				if (jquery('#peixunriqi').val()) {
					param['peixunriqi'] = jquery('#peixunriqi').val() ? '%' + jquery('#peixunriqi').val() + '%' : '';
				}  

					// 获取列表数据
					http.request('peixunxinxi/list', 'get', param, function(res) {
