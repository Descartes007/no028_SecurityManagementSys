		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑优秀员工</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑优秀员工</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">优秀员工信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>评选名称</label>
										<input name="pingxuanmingcheng" id="pingxuanmingcheng" name="pingxuanmingcheng" class="form-control" placeholder="评选名称">
									</div>
									<div class="form-group col-md-6">
										<label>工号</label>
									...
									<div class="form-group col-md-6">
										<label>个人格言</label>
										<input name="gerengeyan" id="gerengeyan" name="gerengeyan" class="form-control" placeholder="个人格言">
									</div>
									<div class="form-group col-md-6">
										<label>评选内容</label>
										<textarea  name="pingxuanneirong" class="form-control" id="pingxuanneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>评选日期</label>
										<div id="pingxuanriqiDate" class="input-append date form_datetime">
											<input id="pingxuanriqi-input" name="pingxuanriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "youxiuyuangong/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("youxiuyuangong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("youxiuyuangong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("youxiuyuangong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#pingxuanriqi-input").val(getCurDate());
			$("#pingxuanriqiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#pingxuanmingcheng").val(ruleForm.pingxuanmingcheng);	
			$("#gonghao").val(ruleForm.gonghao);	
			$("#yuangongxingming").val(ruleForm.yuangongxingming);	
			$("#xiangpian-input").val(ruleForm.xiangpian);
			$("#gerengeyan").val(ruleForm.gerengeyan);	
			$("#pingxuanneirong").val(ruleForm.pingxuanneirong);
			$("#pingxuanriqi-input").val(ruleForm.pingxuanriqi);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pingxuanmingcheng != null && res.data.pingxuanmingcheng != ''){

						$("#pingxuanmingcheng").val(res.data.pingxuanmingcheng);
						$("#pingxuanmingcheng").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.gerengeyan != null && res.data.gerengeyan != ''){

						$("#gerengeyan").val(res.data.gerengeyan);
						$("#gerengeyan").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.pingxuanneirong != null && res.data.pingxuanneirong != ''){

						$("#pingxuanneirong").val(res.data.pingxuanneirong);
					}
					if(res.data != null && res.data != '' && res.data.pingxuanriqi != null && res.data.pingxuanriqi != ''){

						$("#pingxuanriqi-input").val(res.data.pingxuanriqi);
						$('#pingxuanriqiFileName').val(res.data.pingxuanriqi)
					}
				}
			});  
            }
