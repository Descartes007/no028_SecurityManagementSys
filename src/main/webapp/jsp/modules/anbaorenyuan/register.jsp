...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210827/b0640e8f7ed04b5eb4ea646a5e2fb329.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		box-shadow: 0 0 0px 6px rgba(255, 255, 255, 0.6);
	}
	...
	#login-wrapper h1 {
		...
		border-style: solid;
		border-color: rgba(0,0,0,.3);
		background-color: rgba(230, 94, 43, 0);
	...
	#registerForm .form-group .form-control-i {
		...
		border-width: 1px;
		border-style: solid;
		border-color: rgba(149, 100, 156, 1);
	...
	#registerForm button.pull-right {
		...
		border-width: 0;
		border-style: solid;
		border-color: rgba(20, 90, 87, 1);
		background-color: rgba(149, 100, 156, 0.8);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="yuangongxingming" placeholder="员工姓名" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "anbaorenyuan/register";
				$.ajax({ 
					type: "POST",
					url: url,
