		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑工资信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑工资信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">工资信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>工资名称</label>
										<input name="gongzimingcheng" id="gongzimingcheng" name="gongzimingcheng" class="form-control" placeholder="工资名称">
									</div>
									<div class="form-group col-md-6">
										<label>工号</label>
									...
									<div class="form-group col-md-6">
										<label>奖励奖金</label>
										<input id="jianglijiangjin" name="jianglijiangjin" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>应扣费用</label>
										<input id="yingkoufeiyong" name="yingkoufeiyong" class="form-control" onchange="calculation()">
									</div>	
									<div class="form-group col-md-6">
										<label>实际工资</label>
										<input name="shijigongzi" id="shijigongzi" name="shijigongzi" class="form-control" placeholder="实际工资">
									</div>
									<div class="form-group col-md-6">
										<label>备注</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "gongzixinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("gongzixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("gongzixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("gongzixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculation(){
			...
			if($("#jianglijiangjin").val() != null && $("#jianglijiangjin").val() != ""){
				y = y + parseFloat($("#jianglijiangjin").val());
			}
			if($("#yingkoufeiyong").val() != null && $("#yingkoufeiyong").val() != ""){
				y = y - parseFloat($("#yingkoufeiyong").val());
			}
			$("#shijigongzi").val(y);
		...
		function dataBind(){
			...
			$("#jianglijiangjin").val(ruleForm.jianglijiangjin);	
			$("#yingkoufeiyong").val(ruleForm.yingkoufeiyong);	
			$("#shijigongzi").val(ruleForm.shijigongzi);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gongzimingcheng != null && res.data.gongzimingcheng != ''){
						...
						$("#gongzimingcheng").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.jianglijiangjin != null && res.data.jianglijiangjin != ''){

						$("#jianglijiangjin").val(res.data.jianglijiangjin);
						$("#jianglijiangjin").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.yingkoufeiyong != null && res.data.yingkoufeiyong != ''){

						$("#yingkoufeiyong").val(res.data.yingkoufeiyong);
						$("#yingkoufeiyong").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.shijigongzi != null && res.data.shijigongzi != ''){

						$("#shijigongzi").val(res.data.shijigongzi);
						$("#shijigongzi").attr('readonly','readonly');
					}
