...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">工资信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>工资信息管理</span></li>
								<li class="breadcrumb-item active"><span>工资信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">工资信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										工资名称
									</label>
									<input type="text" id="gongzimingchengSearch" class="form-control form-control-sm" placeholder="请输入工资名称" aria-controls="tableId">
									<label>
										员工姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gongzimingcheng')">工资名称<i id="gongzimingchengIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('jibengongzi')">基本工资<i id="jibengongziIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jianglijiangjin')">奖励奖金<i id="jianglijiangjinIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yingkoufeiyong')">应扣费用<i id="yingkoufeiyongIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shijigongzi')">实际工资<i id="shijigongziIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#gongzimingchengSearch').val() != null && $('#gongzimingchengSearch').val() != ''){
				searchForm.gongzimingcheng ="%" +  $('#gongzimingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("gongzixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				gongzimingcheng : searchForm.gongzimingcheng,	
		...
		function setDataRow(item,number){
			...
			var gongzimingchengCell  = document.createElement('td');

						 gongzimingchengCell.innerHTML = item.gongzimingcheng;

			row.appendChild(gongzimingchengCell);
			...
			var jibengongziCell  = document.createElement('td');

						 jibengongziCell.innerHTML = item.jibengongzi;

			row.appendChild(jibengongziCell);
			var jianglijiangjinCell  = document.createElement('td');

						 jianglijiangjinCell.innerHTML = item.jianglijiangjin;

			row.appendChild(jianglijiangjinCell);
			var yingkoufeiyongCell  = document.createElement('td');

						 yingkoufeiyongCell.innerHTML = item.yingkoufeiyong;

			row.appendChild(yingkoufeiyongCell);
			var shijigongziCell  = document.createElement('td');

						 shijigongziCell.innerHTML = item.shijigongzi;

			row.appendChild(shijigongziCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("gongzixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"gongzixinxi");
