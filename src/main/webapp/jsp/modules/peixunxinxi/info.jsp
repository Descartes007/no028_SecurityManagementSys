						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="peixunmingcheng" name="peixunmingcheng" class="form-control" v-model="ruleForm.peixunmingcheng" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>培训地点</label>

									<input id="peixundidian" name="peixundidian" class="form-control" v-model="ruleForm.peixundidian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>培训日期</label>
